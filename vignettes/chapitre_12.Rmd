...
1. Quelle taille font les 1% d'Américains les plus grands ?
1. Quelle taille font les 1% de basketteurs les plus grands ?
1. Combien y a-t-il d'adultes américains au moins aussi grands que Marc
Gasol ? Même question pour Yao Ming.
1. Combien y a-t-il en moyenne de joueurs de basket au moins aussi
   grands que Marc Gasol ? Même question pour Yao Ming.
1. Quelle taille font les 1% d'Américains les plus petits et les 1%
de basketteurs les plus petits ?
1. Combien y a-t-il de joueurs de basket de taille inférieure ou égale
à celle de Mugsy Bugs\ ?
...
de Marc Gasol est donné par la fonction de répartition normale, en
...
`pnorm`. Sans autre argument que la valeur de la variable, elle renvoie
...
revanche, on peut à nouveau utiliser la fonction `pnorm`\ :
...
`r round(mu - 2.33 * sig, 2)`$. Le même résultat peut être obtenu à
l'aide de la fonction `qnorm`. Avec pour seul argument une
probabilité, la fonction renvoie le quantile correspondant à une distribution normale
centrée réduite. 
...
1. Quel est l'écart-type du temps d'attente au péage ?
1. Quelle est la probabilité d'attendre au moins 15mn au péage ?
1. Quelle est la probabilité d'attendre au moins 25mn au péage,
sachant qu'on y est déjà depuis 10mn ?
1. Quelle est l'heure de départ qui permet d'arriver à l'heure avec une
probabilité de 90% ?
...
La probabilité d'attendre au moins 15 mn supplémentaires sachant que
l'attente est déjà de 10mn est donnée par $\mbox{P}(X > t + s | X > t)
