...
complément d'information sur sa candidature. On note $I$ cet évènement
et $\bar{I}$ l'évènement correspondant à une non demande d'information
complémentaire. A partir de l'expérience des années antérieures, on a
déterminé que :
...
- l'entreprise contactée demande des informations complémentaires dans
  18.75% des cas lorsque l'entreprise ne recrute l'étudiant pour un
  stage
  
**Q1.** Quelle est la probabilité que la recherche de stage soit
fructueuse et que des informations supplémentaires soient demandées.
Même question lorsqu'aucune information supplémentaire ne soit
demandée.

**Q2.** Quelle est la probabilité qu'une information complémentaire
soit demandée par l'entreprise.

**Q3.** Un étudiant reçoit une demande d'information complémentaire de
la part de l'entreprise. Quelle est alors la probabilité que sa
...
demande d'information complémentaire soit faite sachant que la
...
**Q3.** Si l'étudiant a reçu une demande d'information complémentaire,
la probabilité que sa demande de stage soit fructueuse est la
probabilité conditionnelle\ : $P(E \mid I) = \frac{P(E \cap I)}{P(I)}
= \frac{0.15}{0.3}=0.5$. Dans la terminologie de la statistique
bayesienne, la probabilité a priori que la demande de stage soit
fructueuse est de 20% alors que la probabilité a posteriori
(l'entreprise a demandé des informations complémentaires) est de
50%. En revanche, si il n'y a pas eu demande d'informations
complémentaires, la probabilité a posteriori est $P(E \mid \bar{I}) = \frac{P(E \cap \bar{I})}{P(\bar{I})}
= \frac{0.05}{0.7}=0.071$, soit 7.1%.
...
- en choisissant 1 numéros (appelé "numéro chance") parmi les nombres
  de 1 à 19.
...
**Q1.** Quelle est la probabilité d'obtenir les 5 bons numéros ?

**Q2.** Quelle est la probabilité d'obtenir les 5 bons numéros et le
numéro chance ? Même question pour les 5 bons numéros sans le numéro
chance ?

**Q3.** Quelle est la probabilité d'obtenir 4 bons numéros ?

**Q4.** Quelle est la probabilité d'obtenir 3 bons numéros ?

**Q5.** Quelle est la probabilité de ne rien gagner ?
...
```
**Q1.** En utilisant la
règle de comptage par combinaisons, on a $\frac{49 !}{5 ! 44!} =$ 
...
**Q2.** Le numéro chance est celui indiquée sur une boule
...
considère le sous-ensemble des combinaisons qui correspondent à ce
...
et une probabilités de $\frac{5 \times C_{44}^4}{C_{49}^5}=`r prob1`$%.
