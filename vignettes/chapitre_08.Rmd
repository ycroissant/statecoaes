...
1. Représentez la série chronologique. Indiquez s'il vous semble qu'il
   y a une composante saisonnière et un trend.
1. La série vous semble t-elle plutôt additive ou multiplicative ?
1. Calculez et représentez la série en moyennes mobiles.
1. Calculez les composantes saisonnières.
1. Calculez et représentez la série détrendée et désaisonnalisée.
...
**Q2.** Lorsqu'on considère les droites qui relient les points
...
popfr %>% select(1:2) %>%
    ...
    kableExtra::kable_styling(position = "center")
```
1. Représentez la série de population.
1. Déterminez la droite de régression de la population en
fonction du temps. Interprétez les coefficients estimés.
1. Déterminez la droite de régression du logarithme de la population
en fonction du temps. Interprétez les coefficients estimés.
