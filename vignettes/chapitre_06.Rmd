...
**Q3.**  $s_x = \sqrt{s_x^2}=2$ et $s_y = \sqrt{s_y^2}=3.2$.  La dispersion
   ...
   premier. 2 et 3.2 peuvent s'interpréter par l'écart moyen par
...
famille et le nombre d'adultes (1 pour les familles mono-parentales et
...
**Q1.**  La distribution marginale des voitures est obtenue en sommant pour
   chaque lignes les probabilités jointes. On obtient 
...
**Q4.**  Les écart-types sont simplement les racines carrés des
...
en mois) et en âge (en tranche d'années). 
...
1. Calculez la distribution conditionnelle des chômeurs selon la durée
   de chômage en fonction de l'âge. Commentez
