...
attribuées, chacune d'entre elle correspondant à un nombre donnés de
...
**Q1.** Déterminez les probabilités d'effectuer 0, 1, 2 ou 3 forages
fructueux pour une concession pour laquelle trois forages sont réalisés.

**Q2.** En cas de forage fructueux, le gain pour l'entreprise est
de 100. Calculez le gain moyen pour l'entreprise lorsqu'elle réalise
trois forages. 

**Q3.** Le coût d'un forage est de 50. Calculez le profit moyen de
l'entreprise pour trois forages.

**Q4.** Quelle est la probabilité que le profit soit positif en
réalisant trois forages ?

**Q5.** Déterminez l'expression générale du profit moyen en fonction
du nombre de forages.

**Q6.** Déterminez le nombre de forages qui maximise le profit moyen.
...
**Q1.** Quel est le coût moyen pour la collectivité de
l'accidentologie\ ?

**Q2.** Quelle est la distribution suivie par le nombre d'accidents
annuel\ ? Quel est le nombre moyen et la variance du nombre
d'accidents ?

**Q3.** Calculez de nouveau la moyenne et la variance en appliquant
l'approximation de la loi de Poisson. Commentez.
...
**Q4.** Expliquez pourquoi la mise en place d'une assurance se traduit
par un accroissement de la probabilité d'avoir un accident.

**Q5.** Ecrivez la fonction de profit de la compagnie
...
**Q6.** Calculez la probabilité que la compagnie d'assurance soit en
...
**Q7.** Calculez de nouveau le montant de la cotisation qui correspond
à un profit en moyenne nulle pour la compagnie d'assurance et la
probabilité que la compagnie soit en déficit.

**Q8.** Calculez la valeur moyenne du coût pour la collectivité des
...
accident est $p=0.005$. Avec les hypothèses que cette probabilité est
la même pour les $n=100$ personnes et que ces probabilités sont
...
car le remboursement de 1000 est exactement égal à la recette. A
...
positif est donc égal à $\mbox{P}(X \leq 1)$, soit la somme des masses
...
d'une variable de Poisson de paramètres $\lambda = n\times p = 0.8$.
